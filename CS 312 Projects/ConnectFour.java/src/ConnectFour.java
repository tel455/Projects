...
/*
 * Displays the initial board and gets user input, 
 * alternating from player 1 and 2 (as well as their respective pieces)
 * and also updates the board until a winner is found
 */
...
//In case the user tries to put their piece into a column thats already full.
