            ...
            <tr>
                ...
                <td>
                    <form action="edit.php" method="get">
                        ...
                        <button onclick="return confirm('Are you sure you want to edit this listing?');">Edit Listing</button>
                    </form>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <form method="get">
                        <!--taken from http://stackoverflow.com/questions/9139075/confirm-message-before-delete-->
                        <button onclick="return confirm('This listing cannot be edited as it has already ended!')">Edit Listing</button>
                    </form>
                </td>
            </tr>
        </tbody>
